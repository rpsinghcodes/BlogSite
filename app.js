...
app.get('/posts/:new', (req, res) =>{
  let parameter = lodash.lowerCase(req.params.new);
  posts.forEach((content)=>{
    if(parameter === lodash.lowerCase(content.postTitle)){
      console.log(content);
      res.render("post", {postHeading:content.postTitle, postContent:content.postBody})
    }else{
